		...
		<div class="row">
			...
			<div class="col-sm-9 padding-right">
				...
				<div class="features_items">
					...
					<c:forEach items="${oList }" var="pvo2" begin="0" end="11">
						<div class="col-sm-4">
				...
				<div class="product__pagination">
					...
					<a href="./product?sv=lio&cp=${paging.prevBlock }"><i class="fa fa-long-arrow-left"></i></a>
					</c:if>
					...
					<c:choose>
						...
						<c:otherwise>
							<a href="./product?sv=lio&cp=${i }">${i }</a>
						</c:otherwise>
					</c:choose>					
					</c:if>
					</c:forEach>
					<c:if test="${paging.nextBlock < paging.totalPage }">
					<a href="./product?sv=lio&cp=${paging.nextBlock }">
